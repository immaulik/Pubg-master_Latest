...
public class ResultFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    String dateRetofit, pubg_name, t_id, timing, first_prize, per_kill, history,
            entry_fee, match_version, map_type, match_type, match_number;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout=view.findViewById(R.id.resultSwipe);
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                Transaction tournament = new Transaction(t_id, pubg_name, history, dateRetofit, timing, first_prize,
                                        entry_fee, match_number, result,usersKill,killPayment,chickenStatus,userPrize);

                                listTransactions.add(tournament);

                            }
                            adapter = new resultAdapter(getContext(), listTransactions);
    ...
    public void onRefresh() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                fragmentTransaction.detach(ResultFragment.this).attach(ResultFragment.this).commit();
            }
        },1000);
    }
}